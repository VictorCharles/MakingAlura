...
[Introdução a HTML e CSS - Caelum (portuguese)](https://www.caelum.com.br/apostila-html-css-javascript/introducao-a-html-e-css/)

[Especificidade de seletores CSS - Caelum (portuguese)](https://www.caelum.com.br/apostila-html-css-javascript/css-avancado/#para-saber-mais-especificidade-de-seletores-css)

[Guia de Unidades CSS - Alura (portuguese)](https://www.alura.com.br/artigos/guia-de-unidades-no-css)

[CSS selectors (game)](https://flukeout.github.io/)

[Propriedade CSS background - Maujor (portuguese)](https://www.maujor.com/tutorial/propriedade-css-para-estilizacao-de-background.php)

[Aplicando filtros CSS - Maujor (portuguese)](https://www.maujor.com/tutorial/css3-filters.php)

[box-model e box-shadow - YouTube (portuguese)](https://youtu.be/pZrAG27KZSg)

[box-shadow - FreeCodeCamp](https://www.freecodecamp.org/news/css-tutorial-drop-shadow/)

[box-sizing - YouTube (portuguese)](https://youtu.be/Q33ojlocKc0)

### Flexbox

[Guia Flexbox - Alura (portuguese)](https://www.alura.com.br/artigos/css-guia-do-flexbox)
...
[About Grid - MDN](https://developer.mozilla.org/pt-BR/docs/Web/CSS/grid)
...
[CSS transitions guide - MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions)
...
[CSS transforms guide - MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Transforms/Using_CSS_transforms)
...
[Animatins - w3schools](https://www.w3schools.com/css/css3_animations.asp)
...
[CSS Animations tips and tricks - MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Animations/Tips)
...
[Color Theory - w3schools](https://www.w3schools.com/colors/colors_theory.asp)

[Harmonia das cores (portuguese)](https://www.amopintar.com/harmonia-das-cores/)

[Cores com harmonia (portuguese)](https://www.alura.com.br/artigos/cores-com-harmonia)
...
[Itmeo - Gradient colors collection](https://webgradients.com/)
...
[Burst - Imagens grátis (portuguese)](https://pt.shopify.com/burst)

[Life of Pix - Free high-resolution photos](https://www.lifeofpix.com/)

[Magdeleine - Hand-picked free photos](https://magdeleine.co/browse/)
...
[StockSnap - Free stock photos](http://stocksnap.com/)
...
[Generative art by Tainá Simões](http://tainasimoes.com.br/generative-art/)
